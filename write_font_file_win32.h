...
Win32WriteFontFile()
{
    ...
    char *FontNames[] = {"Liberation Mono", "Arial"}; 
    char *FileNames[] = {"c:/Windows/Fonts/LiberationMono-Regular.ttf",
                         "c:/Windows/Fonts/arial.ttf"};
    r32 Qualities[ArrayCount(FileNames)][FontQuality_Count];
    Qualities[0][FontQuality_Debug] = 1.0f;
    Qualities[1][FontQuality_Debug] = 0.0f;
    Qualities[0][FontQuality_Size] = 1.0f;
    Qualities[1][FontQuality_Size] = 1.0f;

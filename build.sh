gcc -w meta_generator.cpp -o meta_program.out -std=gnu++11 -DMAC_PORT=1 -DSDL_PORT=1 -O0
./meta_program.out
pushd ../../art_assets
gcc -o mind_man ../Apps/mind_man-master/calm_sdl.cpp -w -lSDL2 -std=gnu++11 -framework OpenGL -O0 -g -DMAC_PORT=1 -DSDL_PORT=1 -DINTERNAL_BUILD
popd
